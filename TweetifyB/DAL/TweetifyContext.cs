...
namespace TweetifyB.DAL
{
    public class TweetifyContext : DbContext
    {
        ...
        {
            optionsBuilder
                .UseMySQL("server=localhost;database=tweetify;user=root;password=iman123");
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Tweet>(entity => 
            {
                ...
                //IL NE SAIT PAS CONVERTIR INT EN BOOL
                entity.Property(p => p.IsRetweet).HasConversion<int>();
